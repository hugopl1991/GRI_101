...
def carregar_dados(file_fuca, file_reclass, cols, size_pixel):
    """Lê e prepara os dados brutos das planilhas."""
    try:
    ...
    return FUCA, Reclass_IBGE, Reclass_canga, Reclass_N4N5
...
def gerar_tabelas_intermediarias(FUCA, cols, path_out_106, path_out_106b, path_out_107,
    ...
    # Tabela 106b (restaurada): mesmo agrupamento, mas com o LULC bruto do ano final
