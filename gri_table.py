import yaml
from utils_gri import carregar_dados, reclass_novo, gerar_tabelas_intermediarias, calcular_balanco

def main():
    print("Iniciando processamento...")

    # ================================
    # Configurações Iniciais do YAML
    # ================================
